...
struct CustomTextFieldWithKeyboard<KeyboardContent: View>: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> UITextField {
        ...
        textField.font = .rounded(ofSize: 28, weight: .semibold)
        ...
        let hostingController = AudioEnabledHostingController(rootView: keyboardContent)
...
private final class AudioEnabledHostingController<Content: View>: UIHostingController<Content>, UIInputViewAudioFeedback {
